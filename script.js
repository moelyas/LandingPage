Shery.imageEffect("#back", {style: 5, config:{"a":{"value":2,"range":[0,30]},
    ...
    "aspect":{"value":1.8283681636282791},"ignoreShapeAspect":{"value":true},
    ...
    "onMouse":{"value":1},"noise_speed":{"value":0.23,"range":[0,10]},"metaball":{"value":0.18,"range":[0,2],"_gsap":{"id":3}},
    "discard_threshold":{"value":0.5,"range":[0,1]},"antialias_threshold":{"value":0,"range":[0,0.1]},
    "noise_height":{"value":0.52,"range":[0,2]},"noise_scale":{"value":15.27,"range":[0,100]}},gooey:true})
